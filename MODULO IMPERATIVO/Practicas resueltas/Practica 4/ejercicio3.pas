...
procedure leerfinales(var f: finales); begin
    readln(f.nota);
...
procedure agregarAdelante(var L: lista; f: finales); begin
    var nue: lista;
    var i: info;
    new(nue);
...
procedure agregarelemento(var a: arbol; f: finales); begin
    var d: data;
...
procedure cargararbol(var a: arbol); begin
    var f: finales;
    leerfinales(f);
    if (f.nota <> -1) then begin
        agregarelemento(a, f);
...
function promedio(L: lista): real; begin
    var suma, total: real;
    suma := 0;
    total := 0;
...
procedure agregarAdelante2(var L: listanueva; d: data); begin
    var nue: listanueva;
    var i: infonue;
    new(nue);
...
procedure retornarcodeprom(a: arbol; codigo: integer; var L: listanueva); begin
    if (a <> nil) then begin
...
procedure informarlista(L: listanueva); begin
    if (L <> nil) then begin
        informarlista(L^.sig);
